  ...
  public: {
    Tables: {
      ...
      bunk_holidays: {
        ...
        Relationships: [
          {
            foreignKeyName: "bunk_holidays_semester_id_fkey"
            columns: ["semester_id"]
            isOneToOne: false
            referencedRelation: "bunk_semesters"
            referencedColumns: ["id"]
          },
        ]
      }
      bunk_missed: {
        ...
        Relationships: [
          {
            foreignKeyName: "bunk_missed_semester_id_fkey"
            columns: ["semester_id"]
            isOneToOne: false
            referencedRelation: "bunk_semesters"
            referencedColumns: ["id"]
      ...
      bunk_timetable_slots: {
        ...
        Relationships: [
          {
            foreignKeyName: "bunk_timetable_slots_semester_id_fkey"
            columns: ["semester_id"]
            isOneToOne: false
            referencedRelation: "bunk_semesters"
            referencedColumns: ["id"]
    ...
    Functions: {
      is_split_creator_or_payer: {
        Args: { p_split_id: string; p_user_id: string }
        Returns: boolean
      }
      is_split_group_member: {
        Args: { p_group_id: string; p_user_id: string }
        Returns: boolean
      }
      is_split_group_owner: {
        Args: { p_group_id: string; p_user_id: string }
        Returns: boolean
      }
      is_split_share_owner: {
        Args: { p_split_id: string; p_user_id: string }
        Returns: boolean
      }
    }
